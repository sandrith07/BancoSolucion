    ...
    class CDTTest
    {
        ...
        */
        ...
        public void ConsigancionInicialMinimoUnMillonCDTTest()
        {
            ...
            //Acción
            var resultado = cdt.Consignar(999999, "01", "12", "2020", "Valledupar");
            //Verificación
        ...
        */
        ...
        public void SoloUnaConsignacionCDTTest()
        {
            ...
            var cdt = new CDT(numero: "10001", nombre: "CDT", ciudad: "Valledupar", termino: "Anual", interes: 0.5);
            //Acción
            var consignacion1 = cdt.Consignar(1200000, "01", "12", "2020", "Valledupar");
            var consignacion2 = cdt.Consignar(3000000, "01", "12", "2020", "Valledupar");
            //Verificación
